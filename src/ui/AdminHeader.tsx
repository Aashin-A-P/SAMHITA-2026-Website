...
const AdminHeader: React.FC = () => {
  ...
  const managementItems = [
    ...
    { label: 'View Passes', onClick: () => { navigate('/admin/passes-display'); setIsMobileMenuOpen(false); } },
    { label: 'Pass Issue', onClick: () => { navigate('/admin/pass-issue'); setIsMobileMenuOpen(false); } },
