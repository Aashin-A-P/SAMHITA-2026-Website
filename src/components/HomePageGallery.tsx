    ...
    <section id="gallery" className="py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 max-w-7xl mx-auto">
        {imagesToShow.map((url, index) => (
          <div key={index} className="bg-gray-900/70 backdrop-blur-md border border-gold-500/30 p-2 rounded-lg overflow-hidden transform transition-transform duration-300 hover:scale-105">
      ...
      {imageUrls.length > 6 && (
        <div className="text-center mt-8">
          <Link to="/gallery" className="inline-flex items-center px-6 py-3 bg-[#d8a000] text-white font-semibold rounded-lg hover:scale-105 transition-transform duration-300 shadow-lg glow-button">
